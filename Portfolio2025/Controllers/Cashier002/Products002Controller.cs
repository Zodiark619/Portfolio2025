...
{
    public class Products002Controller : Controller
    {
        private readonly DatabaseContext _context;

        public Products002Controller(DatabaseContext context)
        {
            _context = context;
        }
